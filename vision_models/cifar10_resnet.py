...
# If substract pixel mean is enabled
...
def resnet_layer(inputs,
    ...
    :param conv_first:  conv-bn-activation(True) or bn-activation-conv (False)
    :return: x : tensor as input to the next layer
    """
